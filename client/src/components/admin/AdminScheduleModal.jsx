...
import { X, Clock, Plus, Trash, Save } from 'lucide-react';
import toast from 'react-hot-toast';

const AdminScheduleModal = ({ doctor, isOpen, onClose, onUpdate }) => {
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
                <div className="p-6 border-b flex justify-between items-center text-white" style={{ backgroundColor: theme.primaryColor }}>
                    <div>
                        <h2 className="text-xl font-bold">Manage Schedule: {doctor.name}</h2>
                        <p className="text-sm opacity-80">Update availability and professional details</p>
                    </div>
                        ...
                        <>
                            ...
                            <section className="space-y-4">
                                <h3 className="text-lg font-bold flex items-center gap-2 text-gray-800">
                                    <Clock size={20} className="text-blue-500" /> Professional Profile
                                </h3>
                                        ...
                                        <div key={index} className="flex flex-col md:flex-row gap-4 items-end md:items-center bg-gray-50 p-4 rounded-2xl border border-gray-100 group transition-all hover:border-blue-200 hover:shadow-sm">
                                            <div className="flex-1 w-full">
                                                ...
                                                <select
                                                    ...
                                                    className="w-full border-gray-200 rounded-lg p-2 text-sm focus:ring-2 focus:ring-blue-500"
                                                >
